...
@section('contenido')
    ...
    <div class="list-group">
        ...
        <a href="{{ route('elegirCurso') }}" class="list-group-item">Actualizar Un Curso</a>
    </div>
    ...
    <div class="list-group">
        ...
        <a href="{{ route('mostrarEstudiantesCursos') }}" class="list-group-item">Agregar un Estudiante a un Curso</a>
        <a href="{{ route('seleccionarCurso') }}" class="list-group-item">Eliminar un Estudiante de un Curso</a>
    </div>
